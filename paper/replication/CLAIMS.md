...
| 1.4 | Noise, **20 seeds per level**: eccentricity on the bar 20/20 to σ≈26, 19/20 at σ≈38, 14/20 at σ≈64, 5/20 beyond; colour and symmetry 20/20 at every level; colour contrast 1.00→0.93 | finding 3 | `--only gray-noise,colour-noise` (`--noise-seeds`, default 20); `results/replication_noise20` | ok — re-measured 2026-09-22, was 5 seeds |
...
| 1.14 | Finding A: lone disk maximum off the object for radius 12/24/40 before the port; after it peaks 0.43/0.82/0.99 at the centre, single edge 0.08. One-sided share of a closed contour: 0.78/0.40/0.32 for radius 12/24/40 (raw sum, gain-invariant), 0.09 with the thesis's offset | finding A | `--only shapes`, `--only symmetry-sides`; `results/replication_symmetry_sides` | ok — measured 2026-09-22; the one number is a range by radius, stated as such in the header, the dossier and the paper |
